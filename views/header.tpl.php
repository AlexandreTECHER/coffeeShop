      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav mx-auto">
            <li class="nav-item <?= $viewName == 'home'? 'active' : '' ?> px-lg-4">
              <a class="nav-link text-uppercase text-expanded" href=".">Home
                <span class="sr-only">(current)</span>
              </a>
            </li>
            <li class="nav-item <?= $viewName == 'about' ? 'active' : '' ?> px-lg-4">
              <a class="nav-link text-uppercase text-expanded" href="./about">About</a>
            </li>
            <li class="nav-item <?= $viewName == 'products' ? 'active' : '' ?> px-lg-4">
              <a class="nav-link text-uppercase text-expanded" href="./products">Products</a>
            </li>
            <li class="nav-item <?= $viewName == 'store' ? 'active' : '' ?> px-lg-4">
